...
<table border="0" cellpadding="2" cellspacing="2" style="border-collapse:collapse;margin-top: 2px;" width="1300px" align="center">
...
<!-- xử lý comment -->
 ...
 <!-- Form góp ý -->
<form action="Chuc_Nang_Gop_Y.php" method="post">
